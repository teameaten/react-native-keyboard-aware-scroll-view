...
const KeyboardAwareMixin = {
  ...
  getInitialState: function (props: Object) {
    ...
    return {
      keyboardSpace: lastKeyboardSpace,
    }
  },
  ...
  updateKeyboardSpace: function (frames: Object) {
    ...
    if (this.props.enableAutoAutomaticScroll && Platform.OS == "ios") {
  ...
  componentDidMount: function () {
    // Keyboard events
    this.keyboardWillShowEvent = Keyboard.addListener(Platform.OS == "ios" ? 'keyboardWillShow': 'keyboardDidShow', this.updateKeyboardSpace)
    this.keyboardWillHideEvent = Keyboard.addListener(Platform.OS == "ios" ? 'keyboardWillHide' : 'keyboardDidHide', this.resetKeyboardSpace)
  },
